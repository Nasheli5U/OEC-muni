...
<div class="container mx-auto px-4">
    ...
    <div class="flex justify-end mb-4">
        ...
        <span class="ml-2 px-3 py-1 bg-gray-800 text-white rounded">{{ $expedienteNumero }}</span>
    </div>
    <form action="{{ route('expedientes.store') }}" method="POST">
        @csrf
        <input type="hidden" name="expediente_numero" value="{{ $expedienteNumero }}">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                <label for="domicilio" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Domicilio</label>
                <input type="text" id="domicilio" name="domicilio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
            </div>
            <div>
            ...
            <div>
                <label for="monto" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Monto</label>
                <input type="text" id="monto" name="monto" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
            </div>
            <div>
